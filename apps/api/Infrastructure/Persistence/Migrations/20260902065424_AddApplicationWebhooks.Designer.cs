...
namespace VeriScan.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260902065424_AddApplicationWebhooks")]
    partial class AddApplicationWebhooks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeriScan.Domain.Entities.ApplicationWebhook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("LastTestHttpStatusCode")
                        .HasColumnType("integer");

                    b.Property<Guid?>("LastTestId")
                        .HasColumnType("uuid");

                    b.Property<long?>("LastTestLatencyMilliseconds")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("LastTestRevision")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("application_webhooks", (string)null);
                });
            ...
            modelBuilder.Entity("VeriScan.Domain.Entities.IdempotentOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ApplicationId", "TargetRequestId", "Operation", "IdempotencyKeyDigest")
                        .IsUnique();
            ...
            modelBuilder.Entity("VeriScan.Domain.Entities.WebhookPublication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ApplicationWebhookId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<long?>("ResponseLatencyMilliseconds")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ApplicationWebhookId");
                    ...
                    b.ToTable("webhook_publications", (string)null);
                });
            ...
            modelBuilder.Entity("VeriScan.Domain.Entities.ApplicationWebhook", b =>
                {
                    b.HasOne("VeriScan.Domain.Entities.ApplicationEntity", null)
                        .WithOne()
                        .HasForeignKey("VeriScan.Domain.Entities.ApplicationWebhook", "ApplicationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("VeriScan.Domain.Entities.WebhookPublication", b =>
                {
                    b.HasOne("VeriScan.Domain.Entities.ApplicationWebhook", null)
                        .WithMany()
                        .HasForeignKey("ApplicationWebhookId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
